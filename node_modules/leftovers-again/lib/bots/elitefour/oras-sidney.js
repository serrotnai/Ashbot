...
var Sidney = function (_EliteFour) {
  _inherits(Sidney, _EliteFour);

  function Sidney() {
    _classCallCheck(this, Sidney);

    var _this = _possibleConstructorReturn(this, (Sidney.__proto__ || Object.getPrototypeOf(Sidney)).call(this));
