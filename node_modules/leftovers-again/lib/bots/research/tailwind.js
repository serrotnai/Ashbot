...
var Tailwind = function (_AI) {
  _inherits(Tailwind, _AI);

  function Tailwind() {
    _classCallCheck(this, Tailwind);

    var _this = _possibleConstructorReturn(this, (Tailwind.__proto__ || Object.getPrototypeOf(Tailwind)).call(this));
