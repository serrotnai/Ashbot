...
var SunnyDay = function (_AI) {
  ...
  function SunnyDay() {
    ...
    var _this = _possibleConstructorReturn(this, (SunnyDay.__proto__ || Object.getPrototypeOf(SunnyDay)).call(this));
  ...
  _createClass(SunnyDay, [{
    ...
    key: 'canSunny',
    value: function canSunny(state) {
      if (!state.self.active) return false;
      if (!state.self.active.moves) return false;
      var sunny = state.self.active.moves.find(function (move) {
        return move.id === 'sunnyday';
      });
